...
function bancoVazio() {
  return {
    ...
    profissionais: [], estoque: [], movimentacoes: [], estoqueEmbrioes: [],
...
function normalizarBanco(data = {}) {
  ...
  const listas = ["clientes","fazendas","doadoras","touros","profissionais","estoque","movimentacoes","estoqueEmbrioes","aspiracoes","producoes","transferencias","congelamentos","servicosSemen"];
